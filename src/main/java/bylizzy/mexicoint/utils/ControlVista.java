...
public class ControlVista {
    ...
    public static String ENCABEZADO = "encabezado.fxml";
    public static String SOLICITAR_PRODUCTO = "solicitarProducto.fxml";

    // MODULOS
    public static String LOGEAR = "homeCliente.fxml";
